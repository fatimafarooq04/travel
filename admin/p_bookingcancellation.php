...
function sendStatusEmail($email, $booking_id, $new_status) {
    ...
    try {
        ...
        $mail->Body = "Dear user,<br>Your booking with ID <strong>$booking_id</strong> has been updated to status: <strong>$new_status</strong>.<br>Thank you.";
...
// Fetch all canceled package bookings
$booking_query = "
...
<div class="container mt-4">
    <h1 class="text-center">Canceled Package Bookings</h1>
    ...
    <?php else: ?>
        <div class="alert alert-info">No canceled package bookings found.</div>
    <?php endif; ?>
</div>
