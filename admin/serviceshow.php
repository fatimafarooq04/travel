...
$total_entries_query = "SELECT COUNT(*) AS total FROM `services`";
...
$query = "SELECT `service_id`, `service_name`, `service_desc` FROM `services` LIMIT $start, $entries_per_page";
...
<div class="container">
    <h1 class="mt-5 text-center">Services List</h1>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="serviceedit.php?updid=<?php echo $row['service_id'] ?>" title="View Details">
                        <button class='btn btn-warning btn-sm'>Edit</button>
                        </a>
                        <a href="servicedelete.php?id=<?php echo $row['service_id'] ?>" title="View Details">
