...
$total_entries_query = "SELECT COUNT(*) AS total FROM `admin_user`";
...
$query = "SELECT `AdminID`, `Name`, `Email`, `Password`, `Phone`, `Role` FROM `admin_user` LIMIT $start, $entries_per_page";
...
<div class="container">
    <h1 class="mt-5 text-center">Admins List</h1>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                    <a href="admindelete.php?id=<?php echo $row['AdminID'] ?>" title="Delete User">
