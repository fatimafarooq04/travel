...
$total_entries_query = "SELECT COUNT(*) AS total FROM `about_us`";
...
$query = "SELECT `about_id`, `about_head`, `about_subhead`, `about_text`, `about_img`, `about_img2`, `about_img3` FROM `about_us` LIMIT $start, $entries_per_page";
...
<div class="container">
    <h1 class="mt-5 text-center">About Us List</h1>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td><?php echo $row['about_subhead'] ?></td>
                    <td>
                        <?php
                    ...
                    <td>
                        <a href="aboutdetails.php?id=<?php echo $row['about_id'] ?>" title="View Details">
