...
// Get the total number of entries in the destination table
$total_entries_query = "SELECT COUNT(*) AS total FROM `destination`";
...
<div class="container">
    <h1 class="mt-5 text-center">Destinations List</h1>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="destinationdetails.php?id=<?php echo $row['DestinationID'] ?>" title="View Details">
