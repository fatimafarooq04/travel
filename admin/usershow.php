...
$total_entries_query = "SELECT COUNT(*) AS total FROM `user`";
...
$query = "SELECT `UserID`, `Name`, `Email`, `Password`, `Phone`, `Role` FROM `user` LIMIT $start, $entries_per_page";
...
<div class="container">
    <h1 class="mt-5 text-center">Users List</h1>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                    <a href="userdelete.php?id=<?php echo $row['UserID'] ?>" title="Delete User">
